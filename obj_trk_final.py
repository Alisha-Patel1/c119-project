...
def goal_track(img,bbox):
    ...
    c1 = x + int(w/2)
    c2 = y + int(h/2)
    cv2.rectangle(img,(c1,c2),2,(0,0,255),5)

    cv2.rectangle(img,(int(p1),int(p2)),2,(0,255,0),3)
    ...
    for i in range(len(xs)-1):
        cv2.rectangle(img,(xs[i],ys[i]),2,(0,0,255),5)
...
while True:
    ...
    if success:
        ...
        cv2.putText(img, "Lost", (70, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,255,0), 2)
